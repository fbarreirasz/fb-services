...
const TOOLS = [
  ...
  {
    id: 'market',
    label: 'Valores do Market',
    desc: 'Verifique os preços atuais de itens no mercado do servidor',
    icon: '📦',
    href: '/ferramentas/market',
    ready: false,
  },
  {
    id: 'skills',
  ...
  {
    id: 'charms',
    label: 'Calculadora de Charms',
    desc: 'Compare o dano médio entre os charms para identificar o melhor',
    icon: '✨',
    href: '/ferramentas/charms',
    ready: false,
  },
  {
    id: 'loot-split',
