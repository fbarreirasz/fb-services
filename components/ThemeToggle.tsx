...
export function ThemeToggle() {
  ...
  if (!mounted) return <div className="h-9 w-9 rounded-full" style={{ background: 'rgba(255,255,255,0.06)' }} />;
  ...
  return (
    <button onClick={toggle}
      ...
      {theme === 'dark'
        ...
        : <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#6d28d9" strokeWidth="2" strokeLinecap="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
      }
    </button>
  );
}
